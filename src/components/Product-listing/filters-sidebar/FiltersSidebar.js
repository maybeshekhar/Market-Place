    ...
    <>
     ...
     {/*    <div className="filter-by-section">
          ...
          <div>
            ...
            />
            <label htmlFor="Womens">Clothing</label>
          </div>
          <div>
            <input
              type="checkbox"
            ...
            />
            <label htmlFor="Mens">Sneakers</label>
          </div>
          <div>
            <input
              type="checkbox"
            ...
            />
            <label htmlFor="Kids">Accesories</label>
          </div>
        </div>
        <hr /> */}
        {/*--------------------------------- Sort By Categories----------------------------------------- */}
        <div className="filter-by-categories">
          ...
          <div>
            ...
            />
            <label htmlFor="activeWear">Athleisure</label>
          </div>
          <div>
            <input
              type="checkbox"
            ...
            />
            <label htmlFor="dresses">Tshirts</label>
          </div>
          <div>
            <input
              type="checkbox"
            ...
            />
            <label htmlFor="tops">Trainers</label>
          </div>
          <div>
            <input
              type="checkbox"
            ...
            />
            <label htmlFor="officeWear">Basketball Tank tops</label>
          </div>
          <div>
            <input
              type="checkbox"
            ...
            />
            <label htmlFor="casual">Sneakers</label>
          </div>
          <div>
            <input
              type="checkbox"
            ...
            />
            <label htmlFor="freestyle">Jewelry</label>
          </div>
          <div>
            <input
              type="checkbox"
            ...
            />
            <label htmlFor="formal">Watches</label>
          </div>
        </div>
      </section>
      {/*--------------------------------- Mobile view filters----------------------------------------- */}
